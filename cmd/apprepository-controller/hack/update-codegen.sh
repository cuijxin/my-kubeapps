...
${REPO_ROOT}/vendor/k8s.io/code-generator/generate-groups.sh "deepcopy,client,informer,lister" \
  github.com/cuijxin/my-kubeapps/cmd/apprepository-controller/pkg/client github.com/cuijxin/my-kubeapps/cmd/apprepository-controller/pkg/apis \
