...
import (
	...
	apprepov1alpha1 "github.com/cuijxin/my-kubeapps/cmd/apprepository-controller/pkg/apis/apprepository/v1alpha1"
	clientset "github.com/cuijxin/my-kubeapps/cmd/apprepository-controller/pkg/client/clientset/versioned"
	"github.com/cuijxin/my-kubeapps/cmd/apprepository-controller/pkg/client/clientset/versioned/scheme"
	appreposcheme "github.com/cuijxin/my-kubeapps/cmd/apprepository-controller/pkg/client/clientset/versioned/scheme"
	informers "github.com/cuijxin/my-kubeapps/cmd/apprepository-controller/pkg/client/informers/externalversions"
...
func (c *Controller) processNextWorkItem() bool {
	...
	err := func(obj interface{}) error {
		...
		// put back on the workqueue and atempted again after a back-off
		// period.
...
func (c *Controller) syncHandler(key string) error {
	...
	if err != nil {
		...
		if errors.IsNotFound(err) {
			...
			// Tigger a Job to perfrom the cleanup of the charts in the DB corresponding to deleted AppRepository
...
// handleObject will take any resource implementing metav1.Object and attemp to
...
func (c *Controller) handleObject(obj interface{}) {
	...
	if object, ok = obj.(metav1.Object); !ok {
		...
		if !ok {
			runtime.HandleError(fmt.Errorf("error decoding object object tombstone, invalid type"))
			return
		}
